...
struct ChunkMeshVertex { // Compressed mesh vertex for chunk
	...
	// x, y, z, axis, face, AO, sunlight, torchlight; resource, u, v
	uint32_t x10_y10_z10_axis2, tex8_face3_ao2_sl6_tl6;
	ChunkMeshVertex(uint32_t x10, uint32_t y10, uint32_t z10, uint8_t axis, BlockFace face, uint8_t ao,
	                uint8_t sunlight, uint8_t torchlight, BlockTexID tex)
