#ifndef HYPERCRAFT_CLIENT_PASS_OITBLENDPASS_HPP
#define HYPERCRAFT_CLIENT_PASS_OITBLENDPASS_HPP
...
public:
	inline void Initialize(myvk_rg::ImageInput color_image, myvk_rg::ImageInput accum_image,
